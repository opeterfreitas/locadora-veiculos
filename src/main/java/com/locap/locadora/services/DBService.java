...
public class DBService {
    ...
    public void instanciaDB() {
        ...
        Vendedor v1 = new Vendedor(null, "Peter Freitas", "550.482.150-95", "peter@mail.com", "123");
        v1.addPerfil(Perfil.ADMIN);
        Vendedor v2 = new Vendedor(null, "Richard Stallman", "903.347.070-56", "stallman@mail.com", "123");
        Vendedor v3 = new Vendedor(null, "Claude Elwood Shannon", "271.068.470-54", "shannon@mail.com", "123");
        Vendedor v4 = new Vendedor(null, "Tim Berners-Lee", "162.720.120-39", "lee@mail.com", "123");
        Vendedor v5 = new Vendedor(null, "Linus Torvalds", "778.556.170-27", "linus@mail.com", "123");

        Cliente c1 = new Cliente(null, "Albert Einstein", "111.661.890-74", "einstein@mail.com", "123");
        Cliente c2 = new Cliente(null, "Marie Curie", "322.429.140-06", "curie@mail.com", "123");
        Cliente c3 = new Cliente(null, "Charles Darwin", "792.043.830-62", "darwin@mail.com", "123");
        Cliente c4 = new Cliente(null, "Stephen Hawking", "177.409.680-30", "hawking@mail.com", "123");
        Cliente c5 = new Cliente(null, "Max Planck", "081.399.300-83", "planck@mail.com", "123");
